...
def social_distancing_view(frame, distances_mat, boxes, risk_count):
    ...
    cv2.putText(pad, "Bounding box shows the level of risk to the person.", (50, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9,
                (0, 0, 0), 2)
    cv2.putText(pad, "-- HIGH RISK : " + str(risk_count[0]) + " people", (50, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.7,
                (0, 0, 255), 1)
    cv2.putText(pad, "-- LOW RISK : " + str(risk_count[1]) + " people", (50, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.7,
                (0, 255, 255), 1)
    cv2.putText(pad, "-- SAFE : " + str(risk_count[2]) + " people", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7,
                (0, 255, 0), 1)
